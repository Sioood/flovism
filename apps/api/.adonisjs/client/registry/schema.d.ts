...
export interface Registry {
  ...
  'auth.access_token.store': {
    ...
    types: {
      ...
      response: ExtractResponse<
        Awaited<ReturnType<import('#controllers/access_token_controller').default['store']>>
      >
      errorResponse:
        | ExtractErrorResponse<
            Awaited<ReturnType<import('#controllers/access_token_controller').default['store']>>
  ...
  'auth.access_token.destroy': {
    ...
    types: {
      ...
      query: {}
      response: ExtractResponse<
        Awaited<ReturnType<import('#controllers/access_token_controller').default['destroy']>>
      >
